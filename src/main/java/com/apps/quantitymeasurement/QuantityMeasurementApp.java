...
import com.apps.quantitymeasurement.service.QuantityMeasurementAuditService;
...
public class QuantityMeasurementApp {
    ...
    private QuantityMeasurementApp(){
        ...
        QuantityMeasurementAuditService auditService = new QuantityMeasurementAuditService(this.repository);
        QuantityMeasurementServiceImpl service = new QuantityMeasurementServiceImpl(auditService);
...
//        System.out.println("Subtract (5F - 2Y): " + subtractResult);
//
...
//        System.out.println("Divide (5F / 2Y): " + divideResult);

//        TO PRINT SAVED DATA
        List<QuantityMeasurementEntity> records = controller.getAllRecords();
